<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="分类" prop="wordCategory">
        <el-input
          v-model="queryParams.wordCategory"
          placeholder="请输入分类"
          clearable
    ...
    <el-table v-loading="loading" :data="wordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类" align="center" prop="wordCategory" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="敏感词内容">
          <editor v-model="form.wordContent" :min-height="192"/>
        </el-form-item>
        <el-form-item label="分类" prop="wordCategory">
          <el-input v-model="form.wordCategory" placeholder="请输入分类" />
        </el-form-item>
      </el-form>
