  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="密码盐值" prop="passwordSalt">
        <el-input
          v-model="queryParams.passwordSalt"
          placeholder="请输入密码盐值"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="密码盐值" align="center" prop="passwordSalt" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="密码盐值" prop="passwordSalt">
          <el-input v-model="form.passwordSalt" placeholder="请输入密码盐值" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除前台用户信息（精简版）编号为"' + userIds + '"的数据项？').then(function() {
